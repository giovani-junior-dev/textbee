    ...
    <div className='flex-1 space-y-6 p-6 md:p-8'>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-2 gap-6'>
        ...
        <div className='space-y-6'>
          <div className='space-y-4'>
            <h3 className='text-lg font-semibold'>{t('management')}</h3>
                ...
                <Button variant="outline" className="w-full justify-start h-auto py-3">
                  <div className='flex items-center'>
                    ...
                    <div className='text-left'>
                      ...
                      <div className='text-sm text-muted-foreground'>{t('editProfileDesc')}</div>
                    </div>
                  </div>
                </Button>
              </Link>
                ...
                <Button variant="outline" className="w-full justify-start h-auto py-3">
                  <div className='flex items-center'>
                    ...
                    <div className='text-left'>
                      ...
                      <div className='text-sm text-muted-foreground'>{t('changePasswordDesc')}</div>
                    </div>
                  </div>
                </Button>
              </Link>
              ...
              <Link href="/dashboard/account/get-support">
                <Button variant="outline" className="w-full justify-start h-auto py-3">
                  <div className='flex items-center'>
                    ...
                    <div className='text-left'>
                      <div className='font-medium'>{t('getSupport')}</div>
                      <div className='text-sm text-muted-foreground'>{t('getSupportDesc')}</div>
                    </div>
                  </div>
                </Button>
              </Link>
